...
import com.example.demo.exceptions.SocketClientException;
...
public class SocketClient {
    ...
    private void create(String host, int port) {
        ...
        try {
            ...
            throw new SocketClientException("Socket Error host:"+host+", port:"+port,
                    ex);
        }
    }
    ...
    public byte[] execute(byte[] message) {
        try{
            ...
            LOGGER.log(Level.SEVERE, "socket execute error", ioex);
            throw new SocketClientException("socket execute error",ioex);
        }
    }
    ...
    public void close() {
        if (this.client != null) {
            try {
                ...
                LOGGER.log(Level.WARNING, "socket close error", ioex);
            } finally {
                this.client = null;
            }
        }
    ...
    public void activate() {
        LOGGER.log(Level.FINE, "... activate socket ...");
    }

    public void desactivate() {
        LOGGER.log(Level.FINE, "... desactivate socket ...");
    }
